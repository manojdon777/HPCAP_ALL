/**
 * @author RookieHPC
 * @brief Original source code at https://rookiehpc.org/mpi/docs/mpi_comm_create_group/index.html
 **/
...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        printf("Process %d (%d) took part to the new communicator broadcast.\n", my_rank,new_rank);
    }
